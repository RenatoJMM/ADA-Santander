...
public class Conta {
    ...
    // }
    //
    // public Conta transferir(String senha, String metodo, BigDecimal valor, Conta
    // destino) {
    ...
    // } else {
    // transfereDinheiro(valor, destino);
    // System.out.println("Mensagem de integração com sistema de transferência
    // interna");
    //
    // }
    // } else {
